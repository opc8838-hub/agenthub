...
with sync_playwright() as p:
    ...
    page.goto('http://127.0.0.1:4173/?v=24', wait_until='networkidle')
    ...
    motion_page.goto('http://127.0.0.1:4173/?v=24', wait_until='networkidle')
    ...
    mobile_motion_page.goto('http://127.0.0.1:4173/?v=24', wait_until='networkidle')
